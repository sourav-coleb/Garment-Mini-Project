...
public class garment{
    ...
    public static void main(String[] args) {
        ...
        // garment object
        Garment garment = new Garment(garmentId, garmentName, garmentDescription, garmentSize, garmentColor,
                garmentPrice, stockQuantity, fabric);
...
class Garment {
    ...
    public Garment(String id, String name, String description, String size, String color, double price,
            int stockQuantity, Fabric fabric) {
        this.id = id;
        this.name = name;
